...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const search__user = document.querySelector('#search__user');
    ...
    document.querySelector('#content__new_info__btn_save').onclick = function() {
        saveNewInfo();
    }

    document.querySelector('#content__new_info__btn_cancel').onclick = function() {
        exitNewInfo();
    }
...
function logInUser() {
    ...
    .then(result => {
        if (result != undefined && !result.error) {
            ...
            localStorage.removeItem('sisys_user');
            user_token = null;
            localStorage.setItem('sisys_token', 'Token ' + result.token);
            localStorage.setItem('sisys_user', email);
